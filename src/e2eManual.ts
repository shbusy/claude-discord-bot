...
export const MANUAL_E2E_CHECKLIST = [
  ...
  'npm run register 실행',
  'npm run run:bot 실행',
  `Discord에서 /cdb init 실행 후 #${PRIMARY_BROWSER_CHANNEL_NAME}, #${PRIMARY_USAGE_CHANNEL_NAME}, ${PRIMARY_SESSIONS_CATEGORY_NAME} 카테고리 확인`,
  '/cdb browse에서 폴더 탐색, 폴더 생성 모달, 모델 버튼, permission mode 확인',
